...
import com.gitee.sqlrest.script.asm.ClassWriter;
import com.gitee.sqlrest.script.asm.Handle;
import com.gitee.sqlrest.script.asm.Label;
import com.gitee.sqlrest.script.asm.MethodVisitor;
import com.gitee.sqlrest.script.asm.Opcodes;
import com.gitee.sqlrest.script.asm.Type;
import com.gitee.sqlrest.script.runtime.MagicScriptRuntime;
...
import com.gitee.sqlrest.script.runtime.handle.ArithmeticHandle;
import com.gitee.sqlrest.script.runtime.handle.BitHandle;
...
import static com.gitee.sqlrest.script.compile.Descriptor.make_descriptor;
...
public class MagicScriptCompiler implements Opcodes {
    ...
    public MagicScriptCompiler(Set<VarIndex> varIndices, boolean debug) {
        ...
        this.load0()
                ...
                .pop();
        // 创建execute方法
        createMethod(ACC_PUBLIC, "execute", Descriptor.make_descriptor(Object.class, MagicScriptContext.class));
        initContext();
    }
    ...
    public MagicScriptCompiler lambda(String methodName) {
        load0();
        Handle metaFactory = new Handle(H_INVOKESTATIC, getJvmType(LambdaMetafactory.class), "metafactory", Descriptor
            .make_descriptor(CallSite.class, MethodHandles.Lookup.class, String.class, MethodType.class, MethodType.class, MethodHandle.class, MethodType.class), false);
        ...
        load2().self().visitMethodInsn(INVOKEVIRTUAL, getClassName(), "createLambda", Descriptor
            .make_descriptor(MagicScriptLambdaFunction.class, MagicScriptLambdaFunction.class, Variables.class), false);
        return this;
    }
    ...
    public MagicScriptCompiler invoke(int opcode, Class<?> target, String method, boolean isInterface, Class<?> returnType, Class<?>... argumentTypes) {
        self().visitMethodInsn(opcode, getJvmType(target), method, Descriptor.make_descriptor(returnType, argumentTypes), isInterface);
        return this;
    }
